    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Visaa.in</span>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+919599076202" className="text-gray-300 hover:text-white transition-colors">
                  95990 76202
                </a>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <a
                  href="https://maps.google.com/?q=D,22,Block+D,Noida+Sector+3,Noida,Uttar+Pradesh+201301"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  D, 22, Block D, Noida Sector 3, Noida, Uttar Pradesh 201301
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-300">© {new Date().getFullYear()} Visaa.in. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
